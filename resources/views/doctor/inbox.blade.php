					...
					<table border="0" width="100%">
                        <table border="1" width="75%" id="myTable">
                            ...
                            <tr id='border' class="header">
                                ...
                                <th id='border'>Id</th>
                                <th id='border'>Sender</th>
                                
                                <th id='border'>Message</th>
                            ...
                            <% for(var i=0; i < data.length; i++){ %>
                                ...
                                <tr id='border'>
                                    ...
                                    <td id='border'><%= data[i].id %></td>
                                     <td id='border'><%= data[i].sender %></td>
                                     <td id='border'><%= data[i].msg %></td>
                                    
                                    

                                    
                                    <td id='border'>
                                        <a href="/doctor/viewmsg/<%= data[i].id %>" class="btn">View Message</a>
                                    </td>
								</tr>
