                        ...
                        <table border="1" width="75%" id="myTable">
                            ...
                            <tr id='border' class="header">
                                ...
                                <th id='border'>Appointment Date</th>
                                  <th id='border'>Appointment Time</th>
                            ...
                            <% for(var i=0; i < users.length; i++){ %>
                                ...
                                <tr id='border'>
                                    ...
                                    <td id='border'><%= users[i].id %></td>
                                    <td id='border'><%= users[i].pname %></td>
                                   
                                    <td id='border'><%= users[i].date %></td>
                                     <td id='border'><%= users[i].time %></td>
                                  
                                    <td id='border'>
                                        <a href="/doctor/PatientProfile/<%= users[i].id %>" class="btn">Accept</a>
                                          <a href="/doctor/PatientProfile/<%= users[i].id %>" class="btn">Reject</a>
                                    </td>
								</tr>
