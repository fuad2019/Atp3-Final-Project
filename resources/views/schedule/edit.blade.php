				...
				<td>
					<table border="0" width="100%">
                         ...
                         <tr>
                            ...
                            <td><input type="date" name="date"  value="{{$schedule->date}}" /> <font color="red"><label></label></font> </td>
                        </tr>

                            <tr> 
                                <!-- set table data -->
                                <td align="right">Time:</td>
                                <td><input type="text"  name="time" placeholder="Please enter time"  value="{{$schedule->time}}"></input> </td>
                            </tr>
                               ...
                               <tr>
                                ...
                                <td><textarea rows="10" cols="100" type="text" name="duty" placeholder="Please enter something" value="{{$schedule->duty}}" ></textarea> </td>
                            </tr>

                           
                            <tr>
                                <td></td>
                                <td><input type="submit" name="submit" value="Update Schedule" class="btn" />  </td>
                            </tr>
